...
class ProjectsController < ApplicationController
  ...
  def index
    ...
    @projects.each_with_index do |proj, i|
      ...
      @traits.push(proj.traits)
    end

   
    # @project_pics = Project.joins(:picture_attachment)
    render json: {projects: @projects, technologies: @technologies, traits: @traits}
  ...
  def project_params
    params.permit(:id, :title, :subtitle, :site_url, :image_url, :local_url, :picture, technology_ids:[], traits_ids: [])
  end
end
